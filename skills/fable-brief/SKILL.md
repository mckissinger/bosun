...
1. Read the spec. Take the done-conditions the user named, or the next unstarted ones that form a coherent slice. Undecided items are out of scope for this slice.
