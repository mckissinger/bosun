...
2. Launch the `fable-verifier` agent with that prompt. While it runs, do not idle: draft the report or continue unrelated remaining work. Do not edit files the verifier is reading.
